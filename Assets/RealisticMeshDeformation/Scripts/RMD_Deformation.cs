...
public class RMD_Deformation : MonoBehaviour {
    ...
    public void OnCollisionEnter(Collision collision) {
        ...
        if (((1 << collision.gameObject.layer) & deformFilter) != 0) {
            ...
            impulse = collision.impulse.magnitude / 10000f;
    ...
    public void triggered_by_collision_proxy(Collision collision)
    {
        //impulse = collision.impulse.magnitude / 10000f;
        ...
        if (impulse > 0f) {
            ...
            //contact point shall be provided by the raycast hit point thingy
